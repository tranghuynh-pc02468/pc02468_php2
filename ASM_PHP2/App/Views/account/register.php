                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3" action="?url=RegisterController/store" method="POST">
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <small class="text-danger"><?= $_SESSION['error']['password2'] ?? '' ?></small>
                                    </div>

                                    <div class="col-12">
                                        <button class="btn btn-primary w-100" type="submit" name="submit">Đăng ký
                                        </button>
                                    </div>
                                    <div class="col-12">
                                        <p class="small mb-0">Bạn đã có tài khoản? <a href="?url=LoginController/index">Đăng
                                                nhập</a></p>
                                    </div>
                                </form>
