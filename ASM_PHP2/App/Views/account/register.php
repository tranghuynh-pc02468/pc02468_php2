              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small"><?= $message_error ?? '' ?></p>
                  </div>

                  <form class="row g-3" action="<?= ROOT_URL ?>?url=RegisterController/store" method="POST" >
                    <div class="col-12">
                    ...
                    <div class="col-12 mb-4">
                      <label for="yourPassword2" class="form-label">Xác nhận mật khẩu</label>
                      <input type="password" name="password2" class="form-control" id="yourPassword2" >
                    </div>

                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="submit">Đăng ký</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Bạn đã có tài khoản? <a href="?url=LoginController/index">Đăng nhập</a></p>
                    </div>
                  </form>
